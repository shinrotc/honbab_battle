...
class WriteScreen extends StatefulWidget {
  ...
  // 🚀 [수정] 닉네임과 함께, 절대 변하지 않는 고유 번호(UID)를 추가로 받습니다.
  ...
  const WriteScreen({
    ...
    required this.currentUid, // UID 전달은 필수!
  });
...
class _WriteScreenState extends State<WriteScreen> {
  ...
  Future<void> _uploadRecipe() async {
    ...
    try {
      ...
      // 🚀 [핵심 수정] 모든 글 저장 시 'authorId'에는 고유 UID를 사용합니다.
      final recipeData = {
        ...
        'authorId': widget.currentUid, // 👈 닉네임 대신 UID 저장!
        'authorNickname': widget.currentNickname, // 👈 화면 표시용 닉네임도 같이 저장!
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: (_pickedFile == null && widget.recipeForEdit?.imagePath == null)
                      ? Column(
